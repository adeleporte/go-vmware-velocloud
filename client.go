...
// APIClient manages communication with the VeloCloud Orchestrator API API v3.3.2
...
func (c *APIClient) callAPI(request *http.Request) (*http.Response, error) {
	...
	//fmt.Printf("\033[1;31m%s\033[0m", fmt.Sprint(res.Body))
	//return res, err
	return res, err
}
...
// Add cookie
func (c *APIClient) AddCookie(cookie string) {
	c.cfg.Cookie = cookie
}
...
func (c *APIClient) prepareRequest(
	...
	// Test Antoine
	headerParams["Accept-Encoding"] = "deflate"
	...
	// Add the cookie
	localVarRequest.Header.Add("Cookie", c.cfg.Cookie)
